			...
			<table id="tbl-search">
				<tr>
					<th colspan="2">
						<select name="searchType">
							...
							<option value="emp_id" ${'emp_id' eq param.searchType ? "selected" : ""}>사번</option> <!-- value에 property가 아닌 column값으로 입력 -->
				...
				<tr>
					...
					<td>
						...
						<!-- (input:radio[name=salaryCompare][value]#salaryCompare$+label[for=salaryCompare$])*2 -->
